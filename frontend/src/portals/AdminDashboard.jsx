...
import { LayoutDashboard, ClipboardList, Users, CreditCard, Bell, Image as ImageIcon, MessageCircle, CheckCircle, XCircle, Trash2, Plus, Clock, Search, FileText, Printer, Edit, Download } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const handleCreateAdmission = (e) => {
    ...
    triggerConfirm(
      ...
      "This will create student and parent records, and generate 12 monthly fee invoices.",
      "submit",
      async () => {
        try {
          const formData = new FormData();
  ...
  return (
    <div className="min-h-screen p-4 -m-4 space-y-6 clay-bg md:-m-8 md:p-8">
      ...
      <div className="grid items-start grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <div className="p-6 space-y-2 text-white lg:col-span-3 clay-sidebar">
          ...
          <button
            ...
            className={`w-full text-left font-quicksand font-bold text-xs p-3 flex items-center space-x-3 transition-all ${
              activeTab === 'stats' ? 'clay-sidebar-item-active' : 'rounded-2xl text-white/80 hover:text-white hover:bg-white/10'
            }`}
          >
          ...
          <button
            ...
            className={`w-full text-left font-quicksand font-bold text-xs p-3 flex items-center space-x-3 transition-all ${
              activeTab === 'admissions' ? 'clay-sidebar-item-active' : 'rounded-2xl text-white/80 hover:text-white hover:bg-white/10'
            }`}
          >
          ...
          <button
            ...
            className={`w-full text-left font-quicksand font-bold text-xs p-3 flex items-center space-x-3 transition-all ${
              activeTab === 'users' ? 'clay-sidebar-item-active' : 'rounded-2xl text-white/80 hover:text-white hover:bg-white/10'
            }`}
          >
          ...
          <button
            ...
            className={`w-full text-left font-quicksand font-bold text-xs p-3 flex items-center space-x-3 transition-all ${
              activeTab === 'announcements' ? 'clay-sidebar-item-active' : 'rounded-2xl text-white/80 hover:text-white hover:bg-white/10'
            }`}
          >
          ...
          <button
            ...
            className={`w-full text-left font-quicksand font-bold text-xs p-3 flex items-center space-x-3 transition-all ${
              activeTab === 'gallery' ? 'clay-sidebar-item-active' : 'rounded-2xl text-white/80 hover:text-white hover:bg-white/10'
            }`}
          >
          ...
          <button
            ...
            className={`w-full text-left font-quicksand font-bold text-xs p-3 flex items-center space-x-3 transition-all ${
              activeTab === 'queries' ? 'clay-sidebar-item-active' : 'rounded-2xl text-white/80 hover:text-white hover:bg-white/10'
            }`}
          >
        ...
        <div className="lg:col-span-9 clay-card p-6 md:p-8 min-h-[400px]">
          ...
          {activeTab === 'admissions' && (
            <div className="space-y-6">
              <div className="flex flex-col justify-between gap-4 border-b pb-4 sm:flex-row sm:items-center border-orange-50">
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    ...
                    className={`px-4 py-2 text-xs font-bold font-quicksand rounded-xl transition-all ${
              ...
              {admissionsSubTab === 'new' && (
                <form onSubmit={handleCreateAdmission} className="p-5 space-y-6 border bg-slate-50/50 border-slate-100 rounded-3xl text-xs">
                  <div>
                  ...
                  <div className="space-y-3">
                    <h5 className="font-bold text-slate-800 border-b pb-1 font-quicksand">1. Student Details</h5>
                  ...
                  <div className="space-y-3">
                    <h5 className="font-bold text-slate-800 border-b pb-1 font-quicksand">2. Parent / Guardian Details</h5>
                  ...
                  <div className="space-y-3">
                    <h5 className="font-bold text-slate-800 border-b pb-1 font-quicksand">3. Required Documents</h5>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-slate-900 hover:bg-slate-800 text-white font-quicksand font-bold text-xs py-3 rounded-xl transition-all shadow"
                  >
                      ...
                      <div key={adm._id} className="flex flex-col items-start justify-between gap-4 p-5 text-xs border bg-slate-50 border-slate-100 rounded-2xl sm:flex-row sm:items-center">
                        ...
                        <div className="flex items-center justify-between w-full gap-3 sm:w-auto sm:justify-end">
                          <span className={`text-[10px] uppercase font-bold px-2.5 py-1 rounded-full border ${
                            adm.status === 'approved' ? 'bg-brandMint/10 text-brandMint-dark border-brandMint/30' :
            ...
            <div className="space-y-6">
              ...
              {usersSubTab === 'registry' && (
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col gap-3 p-4 bg-slate-50 border border-slate-100 rounded-3xl sm:flex-row sm:items-center sm:justify-between text-xs">
                      ...
                      <tbody className="divide-y divide-slate-100 text-slate-700 font-medium">
                        {students.filter(s => {
                          ...
                          students.filter(s => {
                            ...
                            <tr key={std._id} className="hover:bg-slate-50/50 transition-all">
                              <td className="p-4 font-mono font-bold text-slate-850">
                                {std.studentId || 'N/A'}
                              </td>
                              <td className="p-4">
                                <span className="font-bold text-slate-800 font-quicksand text-sm block">{std.name}</span>
              ...
              {usersSubTab === 'direct' && (
                <form onSubmit={handleRegisterStudent} className="p-5 space-y-6 border bg-slate-50/50 border-slate-100 rounded-3xl text-xs">
                  <div>
                    <h4 className="text-sm font-bold font-quicksand text-[#5B468C] mb-1">Direct Student Registration Entry</h4>
                    <p className="text-slate-500 font-semibold">Manually register an existing student directly into the active database. This assigns a unique Student ID and provisions parent credentials immediately.</p>
                  </div>

                  {/* Student Section */}
                  <div className="space-y-3">
                    <h5 className="font-bold text-slate-800 border-b pb-1 font-quicksand">1. Student Profile</h5>
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-4">
                      <div className="space-y-1">
                  ...
                  {/* Parent Section */}
                  <div className="space-y-3">
                    <h5 className="font-bold text-slate-800 border-b pb-1 font-quicksand">2. Parent / Guardian Credentials</h5>
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                      <div className="space-y-1">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-slate-900 hover:bg-slate-800 text-white font-quicksand font-bold text-xs py-3 rounded-xl transition-all shadow cursor-pointer"
                  >
                ...
                <div className="space-y-6 text-xs">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                      {teachers.map(teach => (
                        <div key={teach._id} className="p-4 border bg-white border-slate-100 rounded-2xl flex flex-col justify-between space-y-2 text-xs">
                          <div>
                            ...
                            <h5 className="font-bold text-sm font-quicksand text-slate-800 mt-2">{teach.name || teach.userId?.name}</h5>
          ...
          {activeTab === 'fees' && (
            <div className="space-y-8">
                        ...
                        students.filter(s => {
                          ...
                          return (
                            <button
                              key={s._id}
                              type="button"
                              onClick={() => setFeeStdId(s._id)}
                              className={`w-full text-left px-3 py-2 text-xs flex justify-between items-center transition-all ${
                                isSelected ? 'bg-orange-50 text-brandCoral font-bold' : 'hover:bg-slate-50 text-slate-600'
                              }`}
                            >
                ...
                <div className="grid grid-cols-1 gap-3 text-xs sm:grid-cols-3">
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      className="bg-white border border-slate-200 rounded-xl p-2.5 w-full outline-none font-semibold text-slate-600"
                    >
                      <option value="1200">₹1,200 (Infant Term)</option>
                      <option value="1250">₹1,250 (Toddler Term)</option>
                      <option value="1500">₹1,500 (Preschool Term)</option>
                      <option value="1600">₹1,600 (Pre-K Term)</option>
                    </select>
                  </div>
              ...
              {/* Invoices list */}
              <div className="space-y-4">
                <h3 className="pb-2 text-base font-bold border-b font-quicksand text-slate-800">Issued Invoices</h3>
                <div className="space-y-2 text-xs">
                  {fees.map(f => (
                    <div key={f._id} className="flex items-center justify-between p-4 bg-white border border-slate-100 rounded-xl">
                      <div>
                        <h4 className="font-bold font-quicksand text-slate-800">{f.term}</h4>
                        <p className="text-slate-500 font-semibold mt-0.5">
                          Student ID: {f.studentId?._id || f.studentId} | Amount: <span className="font-bold text-slate-800">${f.amount}</span>
                        </p>
                      </div>
                  ...
                  <div key={q._id} className="p-4 space-y-3 border bg-slate-50 border-slate-100 rounded-xl">
                    <div className="flex items-start justify-between pb-2 border-b border-slate-200/50">
                      ...
                      <span className={`text-[9px] uppercase font-bold px-2 py-0.5 rounded-full border ${
                        q.status === 'resolved' ? 'bg-brandMint/10 text-brandMint-dark border-brandMint/30' :
                        'bg-red-50 text-red-600 border border-red-100'
                      }`}>
                        {q.status}
                      </span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
          <div className="bg-white border-[6px] border-white rounded-[2.5rem] w-full max-w-xl p-6 md:p-8 shadow-2xl relative text-slate-800 max-h-[90vh] overflow-y-auto">
            ...
            <div className="py-4 space-y-5 text-xs">
              ...
              {/* Section 3: Documents */}
              <div className="space-y-2.5">
                <h5 className="pb-1 text-sm font-bold border-b font-quicksand text-slate-800">3. Attached Documents</h5>
                <div className="grid grid-cols-2 gap-3 font-semibold text-slate-500">
                  <div>
                    <span className="text-[9px] text-slate-400 uppercase block">Birth Certificate</span>
                    <span className="font-bold text-slate-800">{selectedAdmission.documents?.birthCertificate || 'None'}</span>
                  </div>
                  <div>
                    <span className="text-[9px] text-slate-400 uppercase block">Student Photo</span>
                    <span className="font-bold text-slate-800">{selectedAdmission.documents?.photo || 'None'}</span>
                  </div>
                </div>
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
          <div className="bg-white border-[6px] border-white rounded-[2.5rem] w-full max-w-xl p-6 md:p-8 shadow-2xl relative text-slate-800 max-h-[90vh] overflow-y-auto">
            <button
              ...
              className="absolute flex items-center justify-center w-8 h-8 font-bold transition-colors rounded-full top-4 right-4 bg-slate-50 hover:bg-slate-100 text-slate-500 text-xl"
            >
              ×
            </button>
            ...
            <div className="pb-4 space-y-1 text-center border-b-2 border-slate-100">
              ...
              <p className="text-xs text-slate-400 font-semibold font-mono">ID: {selectedStudentProfile.studentId || 'N/A'}</p>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <span className="font-bold text-slate-850 text-sm">{selectedStudentProfile.gender}</span>
                  </div>
                  <div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <span className="font-bold text-slate-855 text-sm">{selectedStudentProfile.parentId?.name || selectedStudentProfile.parentDetails?.fatherName || selectedStudentProfile.parentDetails?.motherName || 'N/A'}</span>
                  </div>
                  <div>
                    <span className="text-[10px] text-slate-400 uppercase block font-bold">Phone Number</span>
                    <span className="font-bold text-slate-855 text-sm">{selectedStudentProfile.parentId?.phone || selectedStudentProfile.parentDetails?.phone || 'N/A'}</span>
                  </div>
                  <div className="col-span-2">
                    <span className="text-[10px] text-slate-400 uppercase block font-bold">Email Address</span>
                    <span className="font-mono font-bold text-slate-855 text-sm">{selectedStudentProfile.parentId?.email || selectedStudentProfile.parentDetails?.email || 'N/A'}</span>
                  </div>
                  <div className="col-span-2">
                    <span className="text-[10px] text-slate-400 uppercase block font-bold">Home Address</span>
                    <span className="font-bold text-slate-855 text-sm">{selectedStudentProfile.parentId?.address || selectedStudentProfile.parentDetails?.address || 'N/A'}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
          <form onSubmit={handleEditStudent} className="bg-white border-[6px] border-white rounded-[2.5rem] w-full max-w-xl p-6 md:p-8 shadow-2xl relative text-slate-800 max-h-[90vh] overflow-y-auto">
            ...
            <div className="pb-4 space-y-1 text-center border-b-2 border-slate-100">
              ...
              <p className="text-xs text-slate-400 font-semibold font-mono">ID: {editingStudent.studentId || 'N/A'}</p>
            </div>
